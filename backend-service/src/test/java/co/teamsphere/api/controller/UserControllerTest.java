...
public class UserControllerTest {
    ...
    void updateUserHandler_Success() throws UserException, ProfileImageException {
        ...
        // Act
        ResponseEntity<UserDTO> response = userController.updateUserHandler(request, userId, token);
    ...
    void updateUserHandler_ThrowsException() throws ProfileImageException, UserException {
        ...
        // Act & Assert
        assertThatThrownBy(() -> userController.updateUserHandler(request, userId, token))
